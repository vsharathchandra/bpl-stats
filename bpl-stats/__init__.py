...
class news:
    ...
    def get_news__headlines_url(self):
            news_url = []
    ...
    def update_all(self):
        ...
        self.news_headlines_url = self.get_news_url()
    ...
    def news(self):
        ...
        for i in range(len(self.news_headlines)):
            print ("%s\t" %(self.news_headlines[i]))
            print ("%s\n" %(self.news_headlines_url[i]))
...
class topScorers:
    ...
    def get_top_scorers(self):
        top_scorers = self.soup.select('.statsranking-name a')
    ...
    def top_scorers_goals(self,num=10):
        ...
        return [self.scorers[0:num],self.goals[0:num]]
